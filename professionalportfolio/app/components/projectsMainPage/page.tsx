...
export default function Projects() {
    ...
    if (isLoading) {
        return (
            <div className="text-center">
                {/* Placeholder loading skeleton or spinner */}
                <div className="animate-pulse bg-gray-300 rounded w-24 h-6 mx-auto mb-4"></div>
                <div className="animate-pulse bg-gray-200 rounded w-48 h-6 mx-auto"></div>
    ...
    return (
        <div id="projectsmain" className="bg-[#F0F0F0] relative text-center pt-10 pb-10 px-0 sm:px-4 md:px-20 lg:px-36">
                    ...
                    <div className="relative w-full lg:w-1/2">
                        <div className="relative border-[#4A1942] bg-[#F9F9F9] border-[8px] mx-auto max-w-[600px]">
                            ...
                            <Image
                                ...
                                priority // Prioritize loading of the default image
                            />
                            <div className="absolute inset-0 flex items-center justify-center">
                                ...
                                <Image
                                    ...
                                    loading="lazy" // Lazy load the project image
                                />
                            </div>
                        </div>
                    </div>

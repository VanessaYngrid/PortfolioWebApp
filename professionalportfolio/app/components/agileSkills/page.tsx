                ...
                <div className="max-w-full mx-auto px-4 py-8 text-center">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                        {agileSkills.agile.map((skill, index) => (
                            <div className="bg-[#3d1538] rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105" key={skill + index}>
                    ...
                    <h2 className="text-xl font-bold my-8 text-[#893168]">Certifications</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-6 sm:h-72 lg:h-44">
                        {agileSkills.certification.map((cert, index) => (
                            <div className="bg-[#3d1538] rounded-lg overflow-hidden shadow-lg flex transition-transform transform hover:scale-105" key={cert + index}>
                                ...
                                <div className='flex flex-col justify-center w-1/2 px-4 py-2'>
                                    <h2 className='text-white text-md font-normal pb-4'>{cert}</h2>
                                    <a 
                                        href={`/pdfs/${transformSkillName(cert)}.pdf`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className='text-[#FFB3C1] underline text-md mt-1'
                                    >
                                        View Certificate
                                    </a>
                                </div>
